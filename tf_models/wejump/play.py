...
class WechatAutoJump(object):
    def __init__(self, phone, sensitivity, serverURL, debug, resource_dir, config):
        self.phone = phone
...
if __name__ == "__main__":
    ...
    AI = WechatAutoJump(args.phone, args.sensitivity, args.serverURL, args.debug, args.resource, args.config)
    AI.run()
